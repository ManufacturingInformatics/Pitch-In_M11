...
Arrow Shape All data

Thermal camera data captured by the thermal camera that is inside the machine, converted from the original H264 format to HDF5. Doesn't really have anything useful.

Arrow Shape Top-down thermal camera data
