...
#.............Read image and labels from files.........................................................
           Img = imread(self.Image_Dir + "/" + self.SFiles[self.itr])
           Img=Img[:,:,0:3]
           LabelName=self.SFiles[self.itr][0:-4]+".png"# Assume ROImap name is same as image only with png ending
           ROIMap = imread(self.ROIMap_Dir+ "/" + LabelName)
           if self.ReadLabels:
              Label= imread(self.Label_Dir + "/" + LabelName)
           self.itr+=1
...
#..........Resize and strecth image and labels....................................................................
           Img = np.array(Image.fromarray(Img.astype("uint8")).resize((Sx,Sy),Image.BILINEAR))
           ROIMap = np.array(Image.fromarray(ROIMap.astype("uint8")).resize((Sx,Sy),Image.NEAREST))
           if self.ReadLabels: Label = np.array(Image.fromarray(ROIMap.astype("uint8")).resize((Sx,Sy),Image.NEAREST))
#-------------------------------Crop Image.......................................................................
           MinOccupancy=501
...
######################################Read next batch of images ROI and labels with no augmentation######################################################################################################
    def ReadNextBatchClean(self): #Read image and labels without agumenting
        ...
        for f in range(batch_size):
##.............Read image and labels from files.........................................................
           Img = imread(self.Image_Dir + "/" + self.OrderedFiles[self.itr])
           Img=Img[:,:,0:3]
...
#..........Resize image and labels....................................................................
           Img = np.array(Image.fromarray(Img.astype("uint8")).resize((Sx,Sy),Image.BILINEAR))
           ROIMap = np.array(Image.fromarray(ROIMap.astype("uint8")).resize((Sx,Sy),Image.NEAREST))
           if self.ReadLabels: Label = np.array(Image.fromarray(Label.astype("uint8")).resize((Sx,Sy),Image.NEAREST))
