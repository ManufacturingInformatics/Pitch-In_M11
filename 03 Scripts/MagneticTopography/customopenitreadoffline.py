...
from OpenEIT import reconstruction 
...
path = "D:\BEAM\Scripts\MagneticTopography\Scripts\OpenEIT"
fileone = r"\simdata.txt"
filetwo = r"\anticlockwise_motion.txt"

# number of coils ?
n_el = 32
""" Load Data """
text_file = open(path+fileone, "r")
